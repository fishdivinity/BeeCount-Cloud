...
const docTemplate = `{
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/internal_api.LedgerResponse"
                            }
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_api.CreateLedgerRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_api.UpdateLedgerRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/internal_api.TransactionResponse"
                            }
                        }
                    },
                    "400": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_api.UpdateTransactionRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "internal_api.AttachmentResponse": {
            "type": "object",
            "properties": {
                "created_at": {
                    "type": "string",
        ...
        "internal_api.CreateLedgerRequest": {
            "type": "object",
            "required": [
                "name"
            ],
        ...
        "internal_api.TransactionResponse": {
            "type": "object",
            "properties": {
                "account": {
                ...
                "attachments": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/internal_api.AttachmentResponse"
                    }
                },
                "category": {
        ...
        "internal_api.UpdateLedgerRequest": {
            "type": "object",
            "properties": {
                "currency": {
                    "type": "string",
        ...
        "internal_api.UpdateTransactionRequest": {
            "type": "object",
            "properties": {
                "account_id": {
                    "type": "integer",
